...
- [docs/plans/nondeterministic-model-responses.md:13](../plans/nondeterministic-model-responses.md#L13) records the confirmed env-gated cache decision, with `RESPONSE_CACHE_ENABLED` defaulting on.
