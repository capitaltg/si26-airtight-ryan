    ...
    *,
    ...
    return "\n\n".join(
        [
            ...
            "Write the way a real evaluator speaks: plain and direct. Use short "
            "sentences. Do not use em dashes. Do not pad the reply with three-part "
            "lists or promotional adjectives.",
        ]
    )
